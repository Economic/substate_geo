...
********************************************************************************
!gunzip -k ${miscdata}cps_00087.dta.gz
use ${miscdata}cps_00087.dta, clear
erase ${miscdata}cps_00087.dta
...
forvalues j = 1/6 {
	reg wkswork1 age age2-age5 i.female i.new_educ i.new_race i.new_married i.majorind i.majorocc i.parttime i.year i.statefips [aw=asecwt] if wkswork2 == `j'
	eststo wks`j'
}
